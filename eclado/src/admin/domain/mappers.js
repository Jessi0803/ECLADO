...
export function normalizeOrder(row) {
  ...
  return {
    ...
    couponCodeMask: row.coupon_code_mask || '',
    couponCampaignId: row.coupon_campaign_id || null,
...
export function normalizeMember(row, allOrders, professionalSales = null) {
  ...
  return {
    ...
    studioContactName: row.studio_contact_name || '',
    studioPhone: row.studio_phone || '',
    studioAddress: row.studio_address || '',
    defaultInvoiceCompanyName: row.default_invoice_company_name || '',
    defaultInvoiceTaxId: row.default_invoice_tax_id || '',
