      ...
      <div style={{ maxWidth:1100, margin:'0 auto', padding: isMobile ? '48px 20px' : '80px 32px' }}>
        ...
        <div className="gabout">
          ...
          <ScrollReveal direction="right" delay={100}>
            <img src="assets/images/about-eclado-clinic.jpg" alt="" style={{ width:'100%', height: isMobile ? 240 : 460, objectFit:'cover', display:'block' }} />
          </ScrollReveal>
        </div>
        ...
        <div className="g3">
          {[
            ...
            <ScrollReveal key={item.label} delay={index * 140}>
            <div style={{ textAlign:'center', padding:'36px 20px', border:'1px solid var(--light)' }}>
        ...
        <div className="gabout" style={{ marginTop: isMobile ? 56 : 96 }}>
          <ScrollReveal direction="left">
            <img src="assets/images/philosophy-subimage-1.png" alt="" style={{ width:'100%', height: isMobile ? 240 : 420, objectFit:'cover', display:'block' }} />
          </ScrollReveal>
          <ScrollReveal direction="right" delay={100}>
        ...
        {/* 品牌標語 */}
        <ScrollReveal style={{ textAlign:'center', padding: isMobile ? '56px 0' : '96px 0', borderTop:'1px solid var(--light)', marginTop: isMobile ? 56 : 96 }}>
