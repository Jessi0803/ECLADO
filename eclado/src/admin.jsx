...
function normalizeProduct(row) {
  ...
  const listImageScale = normalizeProductImageScale(row.product_list_image_scale);
  return {
    id: row.id,
    name: row.name || '',
    nameZh: row.name_zh || '',
