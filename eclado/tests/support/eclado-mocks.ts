...
export const mockProducts = [
  ...
  { id: 2, slug: 'peptide-fixed-url', name: 'Peptide Repair Serum', name_zh: '胜肽修護精華液', category: '精華液', size: '30ml', stock: 2, is_pro_only: false, price: 3980, pro_price: 2980, series: 'Cell', image_url: 'https://example.com/mock-product-2.jpg', description: '多重胜肽與保濕修護配方。', skin_type: '乾燥肌、熟齡肌', ingredients: '乙醯六胜肽-8、玻尿酸鈉', features: ['多重胜肽複合修護', '深層長效補水'], active: true },
